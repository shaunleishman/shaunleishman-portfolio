...
export const GALLERY_SECTIONS: GallerySectionMeta[] = [
  {
    id: "buttons",
    title: "Buttons",
    description: "Small, medium, and large buttons. Pick a size, type, and state, or view all variants.",
    category: "Actions",
  ...
  },
  {
    ...
    description: "Full Insight page with sidebar, filters, toolbar, and wide data table, or inspect the parts separately.",
    category: "Data",
