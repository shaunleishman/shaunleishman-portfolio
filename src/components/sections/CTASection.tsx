  ...
  return (
    ...
    >
      {dark && (
        <>
          <Mail
            className="absolute top-12 left-[10%] h-8 w-8 text-white/10 hidden lg:block motion-safe:animate-[fade-in_1s_ease-out]"
            strokeWidth={1.25}
            aria-hidden
          />
          <MessageCircle
            className="absolute bottom-16 right-[12%] h-10 w-10 text-[#3b66f5]/20 hidden lg:block motion-safe:animate-[fade-in_1.2s_ease-out]"
            strokeWidth={1.25}
            aria-hidden
          />
        </>
      )}
      <Reveal className="container-site text-center max-w-2xl mx-auto relative">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Button href="/work" variant="secondary" className={dark ? "!border-white/30 !text-white hover:!border-white" : ""}>
            View my work
          </Button>
        </div>
      </Reveal>
