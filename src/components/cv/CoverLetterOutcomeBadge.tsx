...
type CoverLetterOutcomeBadgeProps = {
  outcomeId: CoverLetterOutcomeId;
  className?: string;
};

export function CoverLetterOutcomeBadge({
  outcomeId,
  className,
}: CoverLetterOutcomeBadgeProps) {
  const outcome = getCoverLetterOutcome(outcomeId);
