...
export const ollyFsUxUiProductCv: CvContent = {
  ...
  summary: [
    ...
    "Figma is the centre of how I work. Component libraries, documentation, tokens, semantic and primitive variables, and advanced prototyping. I keep portfolio evidence of process and craft at www.shaunleishmanportfolio.com.",
  ],
  strengths: [
  ...
  experience: [
    {
      ...
      paragraphs: [
        ...
        "One sprint that sticks with me was synthetic hourly data. Meters were often monthly, but teams needed hourly views. I designed eligibility, activation, and how estimated hours sit next to real readings across graphs, tables, and reports, then handed that to engineering ready to build.",
      ],
    },
    {
      role: "UX Consultant",
