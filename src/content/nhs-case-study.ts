...
export const nhsAtAGlance = {
  summary: "I was the research lead for the NHS 111 team on a four-week discovery project.",
  productGoal:
...
export const nhsMyRole = {
  lead: "The NHS team set the priorities and I led the research.",
  impact:
...
export const nhsProjectTimeline = {
  totalWeeks: 4,
  lead: "4 weeks from brief to final presentation, with me leading research throughout.",
  intro:
