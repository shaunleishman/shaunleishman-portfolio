        ...
        {CASE_STUDY_ENTRIES.map((entry) => (
          ...
          >
            ...
            <Link
              ...
              className="absolute inset-0 z-0 rounded-2xl focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-accent)]"
            ...
            <div className="relative z-10 p-6">
              ...
              <div className="mt-5 flex flex-wrap items-center justify-between gap-3">
                ...
                <CopyShareLinkButton slug={entry.slug} variant="compact" className="relative z-10" />
              </div>
            </div>
          </div>
        ))}
